        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex gap-x-6">
            <Link
              ...
              className="group"
              aria-label="Bodia AI on Twitter"
            >
              <svg
                aria-hidden="true"
            ...
            <Link
              href="https://github.com/tonilopezmr/hackathonai"
              className="group"
              aria-label="Bodia AI on GitHub"
            >
              <svg
                aria-hidden="true"
                className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700"
          ...
          <p className="mt-6 text-sm text-white sm:mt-0">
            Copyright &copy; {new Date().getFullYear()} Bodia AI. All rights
            reserved.
          </p>
        </div>
      </Container>
