        ...
        <div className="relative isolate px-6 pt-16 bg-neutral-900 shadow-2xl sm:rounded-3xl mx-auto">                          
          ...
          <div className="mx-auto max-w-md text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a href="https://github.com/tonilopezmr/hackathonai" class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">Empieza Ahora</a>
